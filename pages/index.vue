<template>
  <div>
    ...
    <div class="kupit">
      <main>
        <img src="/sale-2.jpg" width="540" height="552" title="Товары со скидкой" alt="Купить товары по акции">
        <div class="content">
    ...
    <div class="kupit">
      <main>
        <img src="/Super-Sale.jpg" width="400" height="307" title="Товары по акции" alt="Купить товары по акции - как это работает">
        <div class="content">
